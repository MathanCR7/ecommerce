// --- START OF FILE client/src/Pages/Admin/Orders/ConfirmedOrdersPage.jsx ---
...
const ConfirmedOrdersPage = () => {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const filename = `confirmed_orders_export_${filters.startDate || "all"}_${
        filters.endDate || "all"
      }${
  ...
  if (showMainSpinner && fetchedOrders.length === 0 && !error)
    content = (
      <div className="order-list-page-container loading">
        <FaSpinner className="spinner-icon spin" /> Loading confirmed orders...
      </div>
    );
...
// --- END OF FILE client/src/Pages/Admin/Orders/ConfirmedOrdersPage.jsx ---
